...
Core calls are `calculate`, `edgar-search`, `fetch-page`, `search-page`, and `price-history`. Use the Python executable supplied in the task message. Quote multi-word expressions and queries. Examples:
